...
## 反假设列表
- 趋势跟踪只是牛市 beta：本段 S3b return=30.80%，max_drawdown=6.20%；需结合总报告 bear 段与买入持有对比裁决。
...
|---|---:|---:|---:|---|
| bull | expectancy_after_cost | 307961.6394 | 0.0000 | PASS |
| bull | profit_factor | inf | 1.3000 | PASS |
| bull | max_drawdown | 0.0620 | 0.2000 | PASS |
| bull | trades | 1.0000 | A不要求 | N/A |

## 交易摘要
- filled_orders: 2
- rejected_orders: 0
- forced_hold_events: 0
- final_nav: 1307961.64
